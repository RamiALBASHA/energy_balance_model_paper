UNITS_MAP = {
    ...
    'temperature_air': (r'$\mathregular{T_{air}}}$', r'$\mathregular{(^\circ C)}$'),
    'temperature_soil': (r'$\mathregular{T_{soil}}}$', r'$\mathregular{(^\circ C)}$'),
    'temperature_source': (r'$\mathregular{T_m}$', r'$\mathregular{(^\circ C)}$'),
